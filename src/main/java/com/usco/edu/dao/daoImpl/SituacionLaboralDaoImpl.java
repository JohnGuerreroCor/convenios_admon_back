...
public class SituacionLaboralDaoImpl implements ISituacionLaboralDao {
	...
	public List<SituacionLaboralRespuesta> obtenerRespuestasIdentificacion(String id) {
		...
		String sql = "select slr.slr_codigo, slr.per_codigo, slr.slp_codigo, slp.slp_nombre, slr.sle_codigo, sle.sle_respuesta, slr.slr_fecha from academia3000_john.graduado.situacion_laboral_respuesta slr "
